...
def make_all_denseface(config):
    face_root = "/home/hetianqu/IEMOCAP/IEMOCAP_full_release/Session{}/face/{}"
...
if __name__ == '__main__':
    ...
    config_path = os.path.join('/home/hetianqu/multimodal/mmin/MMIN-master/data/config/IEMOCAP_config.json')
