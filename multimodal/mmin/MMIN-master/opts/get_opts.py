...
class Options():
    ...
    It also gathers additional options defined in <modify_commandline_options> functions in both dataset class and ete_model class.
    """
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--name', type=str, help='name of the experiment. It decides where to store samples and ete_model')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='ete_model are saved here')
        ...
        # ete_model parameters
        parser.add_argument('--ete_model', type=str, default='mmin', help='chooses which ete_model to use. [autoencoder | siamese | emotion_A]')
        ...
        parser.add_argument('--epoch', type=str, default='latest', help='which epoch to load? set to latest to use latest cached ete_model')
        parser.add_argument('--verbose', action='store_true', help='if specified, print more debugging information')
        parser.add_argument('--suffix', default='', type=str, help='customized suffix: opt.name = opt.name + suffix: e.g., {ete_model}_{netG}_size{load_size}')
        
        ## training parameter
        parser.add_argument('--print_freq', type=int, default=100, help='frequency of showing training results on console')
        parser.add_argument('--save_epoch_freq', type=int, default=1, help='frequency of saving checkpoints at the end of epochs')
        parser.add_argument('--continue_train', action='store_true', help='continue training: load the latest ete_model')
        parser.add_argument('--epoch_count', type=int, default=1, help='the starting epoch count, we save the ete_model by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
    ...
    def gather_options(self):
        ...
        Add additional ete_model-specific and dataset-specific options.
        These options are defined in the <modify_commandline_options> function
        in ete_model and dataset classes.
        """
        ...
        # modify ete_model-related parser options
