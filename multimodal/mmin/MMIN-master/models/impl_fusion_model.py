...
class ImplFusionModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--trn_modality', type=str, help='which modality used for training for ete_model')
        parser.add_argument('--test_modality', type=str, help='which modality used for testing for ete_model')
        return parser
