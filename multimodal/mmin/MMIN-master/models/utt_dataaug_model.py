...
from .networks.fc import FcEncoder
from models.networks.lstm import LSTMEncoder
from models.networks.textcnn import TextCNN
from models.networks.classifier import FcClassifier

''' Implement Data augmentation of ete_model fusion
'''
class UttDataAugModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--embd_size_a', default=128, type=int, help='audio ete_model embedding size')
        parser.add_argument('--embd_size_l', default=128, type=int, help='text ete_model embedding size')
        parser.add_argument('--embd_size_v', default=128, type=int, help='visual ete_model embedding size')
        ...
        parser.add_argument('--modality', type=str, help='which modality to use for ete_model')
        return parser
